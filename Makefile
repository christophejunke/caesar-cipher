...
.PHONY: tis
tis:
	@echo -e "\\x1b[00;36mtis-analyzer-gui -64 -cpp-extra-args=\"-I.\" -val -slevel 100 caesar.c main.c\\x1b[00m"
	@tis-analyzer-gui -64 -cpp-extra-args="-I." -val -slevel 100 caesar.c main.c
